...
TEST_CASE("MotorDriver_Init", "[MotorDriver]")
{
    ...
    MotorDriverConfig motorConfigs[] = {
        { .pwma_gpio_num = 48, .pwmb_gpio_num = 35, .encoder_gpio = 36, .pid_params = pid_runtime_param, .label = "motor1" },
        { .pwma_gpio_num = 37, .pwmb_gpio_num = 38, .encoder_gpio = 39, .pid_params = pid_runtime_param, .label = "motor2" },
        { .pwma_gpio_num = 41, .pwmb_gpio_num = 40, .encoder_gpio = 26, .pid_params = pid_runtime_param, .label = "motor3" }
    };
